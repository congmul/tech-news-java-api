...
public class Post implements Serializable {
    ...
    @NotNull                        // @NotNull signals to the Spring Data JPA that this variable is not to be allowed to be null in the database.
    @Temporal(TemporalType.DATE)    // @Temporal allows us to use the type Date in the database and signals to the JPA that these fields will house data of that type.
    @Column(name = "posted_at")     // designates the name of the column for the databas
